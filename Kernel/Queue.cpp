...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, KernelQueueInitialize)
#endif

NTSTATUS
KernelQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = KernelEvtIoDeviceControl;
    queueConfig.EvtIoStop = KernelEvtIoStop;
